...
| forwarder.retry_count    | int      |         | Yes      | Count of attempts to send request to executor if it failed                                                       |
| forwarder.retry_wait     | string   |         | Yes      | Time to wait before next try sending request to executor. Duration string                                        |
| analyzer_name            | string   |         | Yes      | Prefix that will be added to analyzer id header                                                                  |
